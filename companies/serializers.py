...
class GroupsSerializer(serializers.ModelSerializer):
    ...
    def get_permissions(self, obj):
        ...
        for groups in permissions:
            permissions.append({
                "id": groups.permission.id,
                "name": groups.permission.name,
                "codename": groups.permission.codename,
            })
        return permissions
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ("id", "title", "description", "due_date", "created_at", "status", "employee")
